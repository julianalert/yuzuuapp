    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6 hidden">
          <button className="btn w-full bg-linear-to-t from-gray-900 to-gray-700 bg-[length:100%_100%] bg-[bottom] text-white shadow-sm hover:bg-[length:100%_150%] flex items-center justify-center gap-2">
        ...
        {/* Or divider */}
        <div className="text-center text-sm italic text-gray-400 mb-6 hidden">Or</div>
